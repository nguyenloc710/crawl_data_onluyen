...
for a in range(2, lengthSubject):
    time.sleep(3)
    ...
    if lengthPractices > 0:
        for b in range(0, lengthPractices) :
            time.sleep(1)
            print(b)
            ...
            for c in range(0, lengthProblems) :
                    ...
                    while True:
                        ...
                        if len(driver.find_elements(By.XPATH,"//input[@autocomplete='off' and @type='text']")) > 0 :
                            ...
                            if myresult == None:
                                ...
                                print("Trả lời")
                                time.sleep(2)
                        elif driver.execute_script("return document.getElementsByClassName('question-option-label').length") == 4 | driver.execute_script("return document.getElementsByClassName('question-option').length") == 4:
                            print("Case : 8")
                            myresult = findQuestion(questionNumber)
                            if myresult == None:
                                try:
                            ...
                            print("Case : else")
                            source_element = driver.find_elements(By.XPATH, "//div[@class='text-item']")[3]
                            dest_element = driver.find_elements(By.XPATH, "//div[@class='text-item']")[1]
                            # dest_element = driver.find_element(By.XPATH, "//div[@class='content-img']")
                            ...
                            if myresult == None:
                                ...
                                print("Câu trả lời : ", myresultAnswers)
                                print("Id câu hỏi : ", myresultAnswers[0][1])
                                source_element = driver.find_element(By.XPATH, "//div[@class='text-item']")
                                dest_element = driver.find_element(By.XPATH, "//div[@class='content-img']")
                                clickAnswerQuestion()
                                print("Trả lời")
                                time.sleep(2)
